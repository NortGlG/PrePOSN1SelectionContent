...
- และ (and) : $p \land q$ จะเป็นจริงก็ต่อเมื่อทั้ง $p$ และ $q$ เป็นจริงเท่านั้น
- หรือ (or) : $p \lor q$ จะเป็นจริงก็ต่อเมื่อ $p$ หรือ $q$ อย่างน้อย $1$ ตัวเป็นจริงเท่านั้น
- ถ้า...แล้ว (implication) : $p \rightarrow q$ จะเป็นเท็จก็ต่อเมื่อ $p$ เป็นจริงและ $q$ เป็นเท็จเท่านั้น
- ก็ต่อเมื่อ (if and only if) : $p \leftrightarrow q$ จะเป็นจริงถ้า $p$ และ $q$ มีค่าความจริงเหมือนกันเท่านั้น
...
## ประโยคเปิด (Predicate logic, Open Sentence)

ประโยคเปิด $P(x)$ จะเป็นประพจน์ก็ต่อเมื่อมีการใส่ตัวแปร $x$ เข้าไปในประโยค เช่น

$P(x)$ คือ $x$ เป็นนักเรียนม.4

- $P(สมชาย) \implies$ สมชายเป็นนักเรียน ม.4 (ซึ่งสามารถตอบได้ว่าจริงหรือเท็จ จึงเป็นประพจน์)
- $P(สมหญิง) \implies$ สมหญิงเป็นนักเรียน ม.4

$Q(x)$ คือ $x \leq 10$ (จะไม่รู้ว่าเป็นจริงหรือเท็จจนกว่าจะรู้ค่า $x$)

- $Q(4) \implies$ $4 \leq 10$ เป็นจริง
- $Q(10) \implies$ $10 \leq 10$ เป็นจริง
- $Q(15) \implies$ $15 \leq 10$ เป็นเท็จ

## ตัวบ่งปริมาณ (Quantifier)

กำหนดให้ทุก $x$ อยู่ในเอกภพสัมพัทธ์ $\mathbb{U}$

### Universal Quantifier (For all $\forall$)

$\forall x [P(x)]$ จะเป็นจริงก็ต่อเมื่อ $P(x)$ เป็นจริงสำหรับทุกๆ $x \in \mathbb{U}$ เช่น

- ให้ $\mathbb{U} = \{1, 3, 5, 7 \}$ และ $P(x)$ คือ $x$ เป็นเลขคี่

$\therefore \forall x [P(x)]$ จึงเป็นจริงเพราะทุกๆ $x \in \mathbb{U}$ เป็นจริง

### Existential Quantifier (For some $\exists$)

$\exists x [P(x)]$ จะเป็นจริงก็ต่อเมื่อมี $x \in \mathbb{U}$ อย่างน้อยหนึ่งตัวที่ $P(x)$ เป็นจริง เช่น

- ให้ $\mathbb{U} = \{1, 2, 4, 8 \}$ และ $P(x)$ คือ $x$ เป็นเลขคี่

$\therefore \exists x [P(x)]$ จึงเป็นจริงเพราะมี $x = 1$ ที่ทำให้ $P(x)$ เป็นจริง

### การกระจายนิเสธเข้าตัวบ่งปริมาณ

จะทำเหมือนการกระจายนิเสธเข้าไปยังเครื่องหมาย $\land , \lor$ โดยใช้ De Morgan's laws
...
- $\sim \forall x [x \text{ is odd number}] \equiv \exists x [x \text{ is even number}]$ 

นั้นคือเหมือนเราบอกว่า ไม่ใช่ทุก $x$ จะเป็นจำนวนคี่ เราสามารถแปลเป็นอีกแบบได้ว่า มี $x$ อย่างน้อยหนึ่งตัวที่เป็นเลขคู่นั้นเอง